...
@Getter
public final class HmilyPredicateBetweenRightValue implements HmilyPredicateRightValue {
    
    private final HmilyExpressionSegment betweenExpression;
    
    private final HmilyExpressionSegment andExpression;
}

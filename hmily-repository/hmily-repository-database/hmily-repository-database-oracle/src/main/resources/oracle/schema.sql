...
BEGIN
    ...
    IF NUM < 1 THEN
      ...
      EXECUTE IMMEDIATE 'CREATE TABLE hmily_transaction_participant (
             ...
             retry INTEGER  DEFAULT 0  NOT NULL ,
             target_class VARCHAR2(512 )  NOT NULL ,
             target_method VARCHAR2(128 )  NOT NULL ,
             confirm_method VARCHAR2(128 )  NOT NULL ,
             cancel_method VARCHAR2(128 )  NOT NULL ,
             confirm_invocation BLOB  NOT NULL ,
             cancel_invocation BLOB  NOT NULL ,

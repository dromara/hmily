...
public class SwaggerConfig {
    ...
    private static final String SWAGGER_SCAN_BASE_PACKAGE = "com.happylifeplat.tac.demo.springcloud.order.controller";
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("")
                .version(VERSION)
                .contact(new Contact("zhaojun", "", "zhaojun@apache.org"))
                .build();
    }

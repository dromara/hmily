...
public class InventoryController {
    ...
    @RequestMapping("/mockWithConfirmTimeout")
    public Boolean mockWithConfirmTimeout(@RequestBody InventoryDTO inventoryDTO) {
        return inventoryService.mockWithConfirmTimeout(inventoryDTO);
    }
}

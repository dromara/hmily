...
package com.hmily.tcc.spring.boot.starter.springcloud.configuration;

import com.hmily.tcc.core.bootstrap.TccTransactionBootstrap;
import com.hmily.tcc.core.service.TccInitService;
import com.hmily.tcc.spring.boot.starter.springcloud.config.TccConfigProperties;
...
public class SpringcloudHmilyTccAutoConfiguration {


    private final TccConfigProperties tccConfigProperties;

    @Autowired
    public SpringcloudHmilyTccAutoConfiguration(TccConfigProperties tccConfigProperties) {

...
package com.hmily.tcc.spring.boot.starter.configuration;

import com.hmily.tcc.core.bootstrap.TccTransactionBootstrap;
import com.hmily.tcc.core.service.TccInitService;
import com.hmily.tcc.spring.boot.starter.config.TccConfigProperties;
...
public class HmilyTccAutoConfiguration {


    private final TccConfigProperties tccConfigProperties;

    @Autowired
    public HmilyTccAutoConfiguration(TccConfigProperties tccConfigProperties) {

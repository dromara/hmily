...
package com.hmily.tcc.spring.boot.starter.dubbo.configuration;

import com.hmily.tcc.core.bootstrap.TccTransactionBootstrap;
import com.hmily.tcc.core.service.TccInitService;
import com.hmily.tcc.spring.boot.starter.dubbo.config.TccConfigProperties;
...
public class DubboHmilyTccAutoConfiguration {


    private final TccConfigProperties tccConfigProperties;

    @Autowired
    public DubboHmilyTccAutoConfiguration(TccConfigProperties tccConfigProperties) {

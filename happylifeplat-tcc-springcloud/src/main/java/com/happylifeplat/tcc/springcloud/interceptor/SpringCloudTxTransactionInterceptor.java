...
public class SpringCloudTxTransactionInterceptor implements TccTransactionInterceptor {
  ...
  @Autowired
  public SpringCloudTxTransactionInterceptor(
  ...
  public Object interceptor(ProceedingJoinPoint pjp) throws Throwable {
    ...
    String context =
        request == null ? null : request.getHeader(CommonConstant.TCC_TRANSACTION_CONTEXT);
    System.out.println(request.getRequestURI() + "--" + context);

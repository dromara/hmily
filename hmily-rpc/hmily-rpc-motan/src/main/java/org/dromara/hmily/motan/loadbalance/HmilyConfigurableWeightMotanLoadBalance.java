...
/**
 * The type Hmily configurable weight motan load balance.
 *
 * @param <T> the type parameter
 * @author xiaoyu(Myth)
 */
@SpiMeta(name = "hmilyConfigurableWeight")
@Activation(key = {MotanConstants.NODE_TYPE_REFERER})
public class HmilyConfigurableWeightMotanLoadBalance<T> extends ConfigurableWeightLoadBalance<T> {

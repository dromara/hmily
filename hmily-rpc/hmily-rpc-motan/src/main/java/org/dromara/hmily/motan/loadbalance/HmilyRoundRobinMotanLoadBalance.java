...
/**
 * The type Hmily round robin motan load balance.
 *
 * @param <T> the type parameter
 * @author xiaoyu(Myth)
 */
@SpiMeta(name = "hmilyRoundRobin")
@Activation(key = {MotanConstants.NODE_TYPE_REFERER})
public class HmilyRoundRobinMotanLoadBalance<T> extends RoundRobinLoadBalance<T> {

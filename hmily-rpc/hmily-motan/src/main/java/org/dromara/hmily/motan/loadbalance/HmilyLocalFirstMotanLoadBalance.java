...
/**
 * The type Hmily local first motan load balance.
 *
 * @param <T> the type parameter
 * @author xiaoyu(Myth)
 */
@SpiMeta(name = "hmilyLocalFirst")
@Activation(key = {MotanConstants.NODE_TYPE_REFERER})
public class HmilyLocalFirstMotanLoadBalance<T> extends LocalFirstLoadBalance<T> {

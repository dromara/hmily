...
/**
 * The type Hmily random sofa rpc load balance.
 *
 * @author xiaoyu(Myth)
 */
@Extension("hmilyRandom")
public class HmilyRandomSofaRpcLoadBalancer extends RandomLoadBalancer {
    
    /**
     * Instantiates a new Hmily random sofa rpc load balance.
     *
     * @param consumerBootstrap the consumer bootstrap
     */
    public HmilyRandomSofaRpcLoadBalancer(final ConsumerBootstrap consumerBootstrap) {
